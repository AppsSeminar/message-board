...
この markdownFile は、ChatGPT にモックを作ってもらい、製作者が加筆修正しています。  
...
あなたは今から掲示板機能を作成する開発者です。これから以下の条件をもとに、markdown 形式でシーケンス図を作ってください
...
先ほどの markdown を以下の participant で作ってみてください
...
独自のユーザーネーム設定機能を、以下の participant でマークダウンで記述してください
